...
{
    public static event Action<string, string, int, string, List<string>, string, string, string> OnTargetFound;
    ...
    public void TargetFound()
    {
        ...
        OnTargetFound?.Invoke(Id, Name, abilityIndex, possibleAbilities[abilityIndex], possibleAbilities,
